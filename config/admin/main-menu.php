...
return [
    'menuItems' => [
        ...
        'cities' => [
            'title' => Yii::t('cities', 'Cities'),
            'icon' => 'fa fa-user-circle-o',
            'url' => '/admin/cities',
            'active' => $controllerId == 'cities'
        ],
        'offices' => [
            'title' => Yii::t('offices', 'Offices'),
            'icon' => 'fa fa-user-circle-o',
            'url' => '/admin/offices',
            'active' => $controllerId == 'offices'
        ],
        'partners' => [
            'title' => Yii::t('partners', 'Partners'),
            'icon' => 'fa fa-user-circle-o',
            'url' => '/admin/partners',
            'active' => $controllerId == 'partners'
        ],
        'ssettings' => [
            'title' => Yii::t('ssettings', 'SSettings'),
            'icon' => 'fa fa-user-circle-o',
            'url' => '/admin/ssettings',
            'active' => $controllerId == 'ssettings'
        ],
        'positions' => [
